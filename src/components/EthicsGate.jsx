  ...
  return (
    <div className="ethics-gate-overlay">
      <div className="ethics-gate-container">
        <h2 className="ethics-title">생성형 AI 윤리 핵심 가이드</h2>
        <div className="ethics-guides-list">
          {guides.map((guide, index) => (
            <div key={index} className="ethics-guide-item">
              <div className="ethics-guide-header">
                <span className="ethics-guide-title">{guide.title}</span>
        ...
        <div className="ethics-action-area">
          <label className="ethics-checkbox-label">
            ...
            />
            <span>위 윤리 핵심 가이드를 빠짐없이 읽고 이를 지키겠습니다.</span>
          </label>
          <button 
